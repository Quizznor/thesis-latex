...
\cite{collaborationPierreAugerObservatory2016}. \cref{fig:uub-pcb-board} and 
...
implementation and purpose of each component. It follows a brief overview of the
operative functions of the Artix-7 \FPGA \cite{xilinx7SeriesFPGAs2020}, which is
responsible for low-level signal processing, and the tasks of the Xilinx 
Zynq-7020 \SOC \cite{amdZynq7000SoC2023} that handles the front-end electronics 
