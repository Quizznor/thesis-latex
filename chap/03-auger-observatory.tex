...
The fifth and newest \FD-site, the \acl{HE} commissioned 2009, is located close 
to \CO, and looks out over the SD-750 array with three fluorescence telescopes. 
The setup of the optical system is (conceptually) identical to that of the 
standard \FD-sites. However, in the case of \HE, the entire telescope frame can 
be rotated upwards by $30^\circ$. This allows the observation of the upper 
atmosphere, where lower energy \EASs are more prevalent. \HE extends the energy 
scale seen by the \FD downwards by one order of magnitude 
...
(\SI{20}{\mega\hertz} for \HE) and digitized by 12-bit \ADC-converter stages. 
...
electronics achieve this via a simple, hierarchical trigger logic. An \FPGA 
...
simultaneous \FLTs per column per \SI{100}{\nano\second} window is evaluated, 
and passed on to the \SLT-stage.
