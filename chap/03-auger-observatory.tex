...
\todo{mention not named things! gps battery solar panel etc.}
...
\begin{itemize}
	...
	\item A Motorola Oncore UT+ \GPS-receiver calculates the position of the
...
diameter of \SI{3.6}{\meter} and height of $\SI{1.2}{\meter}$ 
The interior is filled with a sealed liner containing \SI{12000}{\liter} of 
filtered water, and shielded from exterior light via a polyethylene housing 
...
particles producing Cherenkov radiation in the water. This light bounces off of 
the reflective interior walls until it reaches one of three identical 
\SI{20}{\milli\meter} \PMTs that are optically coupled to the inside of the 
liner.
