...
which form the \SD, and 27 fluorescence telescopes, that comprise the \FD. All 
data from \SD stations, \FD telescopes as well as numerous atmospheric 
monitoring sites converge at one location, the \CDAS, in the nearby city of 
Malargüe. The observatory is designed to indirectly detect \CRs of incredibly 
high energies, inferring their existence from large particle cascades in the
atmosphere. The \PAO is a hybrid detector. It detects faint fluorescence light
during the formation of an \EAS via the \FD, and it samples the shower 
footprint on ground via the \SD. The simultaneous operation of the \FD and the 
\SD offers a unique possibility to observe \UHECRs at the tail-end of the \CR 
energy spectrum. 
...
studied more deeply. Of particular interest is the reconstruction of the 
primary particle mass from \EAS-data, as this influences the \CRs 
...
Phase-I pre- and during AugerPrime) will be the basis for many contributions 
that attempt to shed light into the physics of \UHECRs, with this work being 
just one example.
