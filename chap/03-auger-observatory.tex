...
\begin{table}
  ...
  \toprule
	...
	\ldelim\{{5}{*}[\parbox{4mm}{\rotatebox[origin=c]{90}{Event level}}]
	 ...
	 & Q^\mathrm{total}_\mathrm{MIP} & $\sim\SI{5}{\percent}$ & Integrated 
	 signal received by the \SSD \PMT & 
	 \cref{sssec:reconstruction-trace-calibrator} \\
	 & & & & \\
	 & & & & \\
	 & & & & \\
...
where $\omega_i = \sqrt{\Qvem_i}$, and $\mathrm{W}=\sum\,\omega_i$. From this,
...
\begin{figure}[t]
  \centering
  \subfloat[]{\includegraphics[height=0.48\textwidth]{auger-observatory/ldf_beta.png}
  \label{fig:ldf-beta}
  }\hspace{0.2cm}
  \subfloat[]{\includegraphics[height=0.48\textwidth]{auger-observatory/ldf_gamma.png}
  \label{fig:ldf-gamma}
  }
  \caption[]{\subref{fig:ldf-beta} adada \subref{fig:ldf-gamma} adada }
  \label{fig:ldf}
\end{figure}
