...
\begin{equation}
\label{eq:NKG}
S(r) = 3.47^{\,\beta}\,S(1000)\left[ \frac{r}{r_\mathrm{s}}\left(1+\frac{r}{r_\mathrm{s}}\right)\right]^{-\beta} .
\end{equation}

In \cref{eq:NKG}, it is $r_\mathrm{s}=\SI{100}{\meter}$, and 
$\beta=2.16\,(\sec\,\theta - 1)$. $S(1000)$, often referred to as the shower 
size, is a standardized parameter that gives the signal of a hypothetical 
station located at a \SPD of exactly \SI{1000}{\meter}.

% LDF plot with different beta?
