...
\begin{table}
  ...
  \toprule
	...
	\ldelim\{{5}{*}[\parbox{4mm}{\rotatebox[origin=c]{90}{Event level}}]
	 ...
	 & $\vec{r}_\mathrm{bary.}$ & \SI{2}{\percent} & Shower core position 
	 on Earth & \cref{sssec:reconstruction-plane-fit} \\ 
...
relative uncertainty on the core position $r_\mathrm{bary.}$ is given as 
\SI{2}{\percent} in \cite{ghiaStatisticalSystematicUncertainties2005}.
...
estimate of $r_\mathrm{bary.}$ in the process.
