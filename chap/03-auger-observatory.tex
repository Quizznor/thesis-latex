...
\cite{Fenu2023}. Thus, to make statistically relevant statements about the 
dynamics of \UHECRs a large (by area) detector and long observation time are 
needed.
...
\begin{figure}[t]
  ...
  \subref{fig:fd-schematic} A schematic view inside a single telescope, or bay, 
