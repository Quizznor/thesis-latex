...
\begin{table}
	...
	\EAS reconstruction.}
	\begin{tabular*}{1.0\textwidth}{M{0.7cm}M{1.9cm}M{1.3cm}|M{7.25cm}|M{2.1cm}}
  \toprule
	...
	level}}]
	 ...
	 ada & Integrated signal received by the \SD \PMTs & 
...
in \cite{todo}. \todo{describe}.

Once finalized, the integral of the \FADC trace within the determined signal 
window is calculated and divided by the corresponding charge calibration 
factor. The recovered quantity is the total \EAS signal 
$Q^\mathrm{total}_\mathrm{VEM}$/$Q^\mathrm{total}_\mathrm{MIP}$, and will be 
reused at a later stage of the reconstruction.
