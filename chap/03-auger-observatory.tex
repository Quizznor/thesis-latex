...
particle cascades in the atmosphere. The \PAO achieves this in a hybrid 
fashion, with the \FD being sensitive to the faint fluorescence light produced 
in an \EAS, whereas the \SD samples the shower footprint on ground. The 
simultaneous operation of the \FD and the \SD offers a unique possibility to 
observe \UHECRs at the tail-end of the \CR energy spectrum. 

This chapter introduces the observatory. A summary of the project history and
the science case of the Pierre Auger collaboration is given in 
\cref{sec:project-history-and-future}. \cref{sec:fd}, and \cref{sec:sd} detail 
the hardware and software detector components of the \FD and the \SD 
respectively. Finally, the analysis chain from \EAS detection to the estimation
...
The two realized that the flux of \UHECRs is very low 
...
possible detection of an astrophysical source of high-energy $\gamma$-rays 
...
experiment. Cronin and Watson gathered support for their ideas and, in 1995, 
founded a collaboration of 140 scientists in 17 participating countries. A 
...
still incomplete detector the largest observatory for \CRs by the end of 2003.
...
Naturally, new insights sprout new questions. The existence of \UHECRs beyond 
...
flaggsStudyingMassSensitivity2024}. Information on the mass composition of \CRs
will significantly advance our understanding of high-energy physics in 
particular, and the cosmos as a whole.
...
have astroparticle physicists excited, and resulted in the strong support to 
extend the observatories funding until beyond the year 2030 
...
the \FD is a crucial component in the analysis chain, as it is able to directly
observe the longitudinal shower profile of an \EAS.
